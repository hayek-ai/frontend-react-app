    ...
    <Paper elevation={0} style={{ borderRadius: 0 }}>
      ...
      >
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          individual user ("you") for your individual usage, subject to
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          intended for children under 18. If it comes to Hayek's attention
          through reliable means that a registered user is a child under 18
          years of age, Hayek will cancel that user's account.
        </Typography>
        <Typography variant="h5" className={classes.heading}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          person. You further understand that none of the bloggers, information
          providers, app providers, or their affiliates are advising you
          personally concerning the nature, potential, value or suitability of
          any particular security, portfolio of securities, transaction,
          investment strategy or other matter. To the extent that any of the
          content published on the Site may be deemed to be investment advice or
          recommendations in connection with a particular security, such
          information is impersonal and not tailored to the investment needs of
          any specific person. You understand that an investment in any security
          is subject to a number of risks, and that discussions of any security
          published on the Site will not contain a list or description of
          relevant risk factors. In addition, please note that some of the
          stocks about which content is published on the Site have a low market
          capitalization and/or insufficient public float. Such stocks are
          subject to more risk than stocks of larger companies, including
          greater volatility, lower liquidity and less publicly available
          information. Blogs, postings or content on the Site which may or may
          not be deemed by you to be recommendations may have an effect on their
          stock prices.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          You understand that the Site may contain opinions from time to time
          with regard to securities mentioned in other Hayek blogs or products,
          and that opinions in one blog or product may be different from those
          in another blog or product. We require all employees to disclose every
          ...
          blog, post, or content which they write. However, you understand and
          agree that non-employees, including outside bloggers or other content
          ...
          account, and that they may or may not be subject to a disclosure
          policy. In cases where Hayek becomes aware that one of its employees
          has violated his or her disclosure obligation, Hayek will take
          appropriate action. In addition, outside bloggers or content
          contributors may be subject to certain restrictions on trading for
          their own account. However, you understand and agree that at the time
          of any transaction that you make, one or more bloggers or content
          contributors or their affiliates may have a position in the securities
          they write about.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          You understand that performance data is supplied by sources believed
          to be reliable, that the calculations on our Site are made using such
          data, and that such calculations are not guaranteed by these sources,
          the information providers, or any other person or entity, and may not
          be complete.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          ...
          reference only a portion of an article or opinion, and are likely not
          to be current. As markets change continuously, previously published
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          for any security by Hayek or any third party. You alone are solely
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          services, links, User Submissions (as defined below), third-party
          apps, and any other content on the Site ("Content") and the
          trademarks, service marks and logos contained therein are the property
          of Hayek and its third-party licensors or providers. You may access
          and use the Content, and download and/or print out copies of any
          content from the Site, solely for your personal, non-commercial use.
          ...
          therein. You acknowledge that you do not acquire any ownership rights
          by using the Site. Hayek reserves all rights not expressly granted in
          and to the Site.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          ...
          control nor endorse such other websites or Content, nor have we
          reviewed or approved any Content that appears on such other websites
          or on our Site. Please read the terms of use and privacy policy of any
          such third party sites that you interact with before you engage in any
          activity. You are solely responsible and liable for your use of and
          linking to all third party sites. You acknowledge and agree that we
          shall not be held responsible for the legality, accuracy, or
          appropriateness of any Content, advertising, products, services, or
          information located on our Site or any other websites, nor for any
          loss or damages caused or alleged to have been caused by the use of or
          reliance on any such content. Similarly, while we endeavor to
          facilitate the provision of quality apps, we are not responsible for
          any loss or damages caused or alleged to have been caused by their
          use.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          upload, post, transmit, distribute, create derivative works or
          otherwise exploit Content from the Site to online bulletin boards,
          message boards, newsgroups, chat rooms, or in other any manner,
          without our prior written permission. Modification of the Content or
          use of the Content for any purpose other than your own personal,
          noncommercial use is a violation of our copyright and other
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          made available therein. We aim to prevent, detect and not knowingly
          facilitate money laundering and terrorism financing activities. You
          may not use the Site in a manner which violates our anti-money
          laundering, counter terrorist financing or similar regulatory
          obligations.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          ...
          obtain information about you which is required to verify your
          identity. We may require you to provide additional information or
          documents to verify your identity, including your date of birth,
          physical address, taxpayer or other identification number, your
          physical address, government issued identification document or other
          information that will allow us to reasonably identify you.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          not be liable for your losses caused by any unauthorized use of your
          account.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          system, including from those who give permission to Hayek to post
          their Content ("User Submissions") and the hosting, sharing and
          publishing of such User Submissions on the Site. Hayek has the right
          in its sole discretion and without further notice to you, to monitor,
          censor, edit, move, delete, and/or remove any and all Content posted
          on its Site or any Content transmitted by direct messaging or by any
          other method to or from your Hayek user account at any time and for
          any reason. Without limiting the foregoing, Hayek has the right to
          delete any comment or Content that it believes, in its sole
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          uncivilized discussion, mudslinging, inappropriate language, and
          blanket dismissal of others' ideas. At our discretion, we may delete
          comments and user submissions, and block/delete accounts of users we
          believe lower the level of discourse and courtesy we strive to
          engender.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          without the help of a broker. They are not the place for stock
          touters, cheerleaders or hypesters. We strongly encourage all
          participants to disclose any positions they have in stocks being
          discussed.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          ...
          responsible, intelligent and informative. We cannot guarantee that
          users will tell the truth, and we will not monitor the veracity of
          names and positions or the content of any posts. However, by setting
          out the above guidelines, we hope to raise the credibility of the
          discussion and foster a spirit of open, honest exchanges of
          information.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          If an author has a business relationship with a company named in an
          article that he or she has authored, that relationship must be fully
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          review all of the information that you communicate to us, but we may
          not be able to take action or respond directly to each email.
        </Typography>
        <Typography variant="h5" className={classes.heading}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          survey or in connection with a particular User Submission
          (collectively, "Feedback"), Hayek may use such Feedback for any
          purpose, including without limitation to provide it to authors on
          their dashboard. In order that we may incorporate such Feedback into
          Hayek’s Site and/or services, Hayek alone will own all right, title
          and interest, including all related intellectual property rights, in
          and to all such Feedback and you hereby assign such Feedback to Hayek
          free of charge.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          While we believe that the Site can and should be a positive
          environment for the exchange of information, you understand that the
          Site is open for posting to all users. Some individuals may post
          comments that may be offensive, indecent, objectionable, false,
        ...
        <Typography variant="body1" className={classes.paragraph}>
          Each individual who submits a User Submission, whether published on
          the Site or not, is solely responsible for her or his own acts,
          including the content, context or information in the User Submission
          he or she submits. This means that each individual, and not Hayek, is
          entirely responsible for anything and everything she or he posts on
          the Site. Hayek does not, and does not intend to, pre-screen any
          comments posted on its Site, and Hayek cannot and does not guarantee
          the accuracy, integrity or quality of anything that may appear on its
          Site.
        </Typography>
        <Typography variant="h5" className={classes.heading}>
          11. Disclosure
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          (e) protect the rights, property or safety of Hayek, its users,
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          BY APPLICABLE LAW, HAYEK, ITS OFFICERS, DIRECTORS, EMPLOYEES,
          AFFILIATES, SUPPLIERS, ADVERTISERS, AGENTS, INFORMATION PROVIDERS AND
          ANY OTHER THIRD PARTY INVOLVED IN OR RELATED TO THE MAKING OR
          COMPILING OF THE SITE DISCLAIM ALL WARRANTIES, EXPRESS, IMPLIED OR
          STATUTORY, INCLUDING, BUT NOT LIMITED TO, WARRANTIES OF TITLE AND
          NON-INFRINGEMENT, IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS
          FOR A PARTICULAR PURPOSE, AND ALL WARRANTIES RELATING TO THE
          ORIGINALITY, ADEQUACY, ACCURACY, TIMELINESS, MERCHANTABILITY OR
          COMPLETENESS OF ANY INFORMATION ON OUR SITE.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          MAKING OR COMPILING OF THE SITE DO NOT WARRANT THAT YOUR USE OF THE
          SITE WILL BE UNINTERRUPTED, ERROR-FREE OR SECURE, OR THAT THE SITE OR
          THE SERVER(S) ON WHICH THE SITE IS HOSTED ARE FREE OF VIRUSES OR OTHER
          ...
          SPONSORS, INFORMATION PROVIDERS OR VISITORS, WHETHER MADE ON THE SITE
          OR OTHERWISE, SHALL CREATE ANY WARRANTY.
        </Typography>
        <Typography variant="h5" className={classes.heading}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          TO THE MAKING OR COMPILING OF THE SITE ARE LIABLE FOR LOST PROFITS,
          LOST SAVINGS OR ANY INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL,
          ...
          TO THE SITE AND/OR ANY CONTENT CONTAINED THEREIN, OR ANY PRODUCT OR
          SERVICE USED OR PURCHASED THROUGH HAYEK. SUCH LIMITATION SHALL APPLY
          REGARDLESS OF THE FORM OF ACTION, EVEN IF HAYEK, ITS INFORMATION
          PROVIDERS, OR ANY OTHER THIRD PARTY INVOLVED IN OR RELATED TO THE
          MAKING OR COMPILING OF ANY PART OF THE SITE HAS BEEN ADVISED OF OR
          OTHERWISE MIGHT HAVE ANTICIPATED THE POSSIBILITY OF SUCH DAMAGES. YOUR
          SOLE REMEDY FOR DISSATISFACTION WITH THE SITE IS TO STOP USING IT. THE
          SOLE AND EXCLUSIVE MAXIMUM LIABILITY TO HAYEK FOR ALL DAMAGES, LOSSES,
          AND CAUSES OF ACTION (WHETHER IN CONTRACT, TORT (INCLUDING, WITHOUT
          LIMITATION, NEGLIGENCE), OR OTHERWISE) SHALL NOT EXCEED THE TOTAL
          AMOUNT PAID TO US BY YOU, IF ANY, FOR ACCESS TO THE SITE OR ANY
          SERVICES, DURING THE PREVIOUS SIX (6) MONTHS PRIOR TO BRINGING THE
          CLAIM. IN NO EVENT SHALL HAYEK, ITS INFORMATION PROVIDERS OR ANY THIRD
          PARTY INVOLVED IN OR RELATED TO THE MAKING OR COMPILING OF ANY OF THE
          GICS SERVICE (DEFINED BELOW), BE LIABLE TO YOU, OR ANY OTHER PERSON,
          FOR ANY DIRECT OR INDIRECT DAMAGES, INCLUDING, WITHOUT LIMITATION, ANY
          LOST PROFITS, LOST SAVINGS OR OTHER INCIDENTAL OR CONSEQUENTIAL
          DAMAGES ARISING OUT OF THE USE OR YOUR INABILITY TO USE THE GICS
          SERVICE.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
        ...
        <Typography variant="body1" className={classes.paragraph}>
          ...
          indirectly out of or from (a) your violation of the TOU; (b) your use
          or any third party’s use of, or inability to use, the Site; (c) your
          violation of the rights of any third party, or (d) any claim that one
          of your User Submissions caused damage to a third party. This defense
          and indemnification obligation will survive these TOU and your use of
          the Site.
        </Typography>
        <Typography variant="h5" className={classes.heading}>
          15. Termination
        ...
        <Typography variant="body1" className={classes.paragraph}>
          You understand and agree that Hayek may, under certain circumstances
          and without prior notice to you, terminate your access to and use of
          the Site. Cause for such termination shall include, but not be limited
          to, (i) breaches or violations of the TOU or other agreements or
          guidelines, (ii) requests by law enforcement or other government or
          regulatory authorities or (iii) repeat violators of third party
        ...
        <Typography variant="body1" className={classes.paragraph}>
          Hayek respects the intellectual property of others, and we ask our
          users to do the same. Hayek may, in appropriate circumstances and at
          its discretion, terminate the account or access of users who infringe
        ...
        <Typography variant="body1" className={classes.paragraph}>
          By downloading Hayek's mobile application on your iPhone® mobile
          device (the "Licensed Application"), your use of the Licensed
          Application is also subject to the Usage Rules established by Apple,
        ...
        <Typography variant="body1" className={classes.paragraph}>
          The Site is directed solely to individuals residing in jurisdictions
          in which provision of the Site's content is legal. We make no
          ...
          own risk, and are responsible for compliance with local laws, if and
          to the extent applicable. We reserve the right to limit the
          availability of the Site to any person, geographic area, or
          jurisdiction we so desire, at any time and in our sole discretion, and
          to limit the quantities of any such service or product that we
          provide.
        </Typography>
        <Typography variant="body1" className={classes.paragraph}>
          The TOU, together with all Hayek policies referred to herein,
          constitutes the entire agreement between you and Hayek relating to
          your use of the Site and supersedes and any all prior or
          contemporaneous written or oral agreements on that subject between us.
          The TOU, privacy policy and the relationship between you and Hayek are
          governed by and construed in accordance with the laws of the State of
          New York, without regard to its principles of conflict of laws. You
          and Hayek agree to submit to the personal and exclusive jurisdiction
          of the federal and state courts located within New York County, New
          York, and waive any jurisdictional, venue, or inconvenient forum
          objections to such courts. If any provision of the TOU is found to be
          unlawful, void, or for any reason unenforceable, then that provision
          shall be deemed severable from the TOU and shall not affect the
          ...
          heading, caption or section title contained in the TOU is inserted
          only as a matter of convenience and in no way defines or explains any
          section or provision hereof. We reserve the right to require you to
          sign a non-electronic version of the TOU.
        </Typography>
      </div>
    </Paper>
  );
